...
get surname_r(){return this._getter('surname_r')}
set surname_r(v){this._setter('surname_r',v)}
get moniker_r(){return this._getter('moniker_r')}
set moniker_r(v){this._setter('moniker_r',v)}
get patronymic_r(){return this._getter('patronymic_r')}
set patronymic_r(v){this._setter('patronymic_r',v)}
get cause_r(){return this._getter('cause_r')}
set cause_r(v){this._setter('cause_r',v)}
get position_r(){return this._getter('position_r')}
set position_r(v){this._setter('position_r',v)}
get position(){return this._getter('position')}
set position(v){this._setter('position',v)}
get predefined_name(){return this._getter('predefined_name')}
set predefined_name(v){this._setter('predefined_name',v)}
get extra_fields(){return this._getter_ts('extra_fields')}
set extra_fields(v){this._setter_ts('extra_fields',v)}
