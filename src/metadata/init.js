...
class CatActivityManager extends CatManager {
  constructor(owner, class_name) {
    super(owner, class_name);
...
$p.cat.create('activity', CatActivityManager, false);
